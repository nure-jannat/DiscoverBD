                ...
                <div class="card-body">
                  <form class="form-sample"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label class="col-sm-12 pl-0 pr-0">Name</label>
                        <div class="col-sm-12 pl-0 pr-0">
                          <input type="text" class="form-control" name="packagename" id="packagename" placeholder="Package Name" required>
                        </div>
                      </div>
                    ...
                    <div class="row">
                     ...
                     <div class="form-group col-md-6 pl-md-0">
                      ...
                      <div class="col-sm-12 pl-0 pr-0">
                        <input type="text" class="form-control" name="packageprice" id="packageprice" placeholder=" Price" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">  
                    <div class="form-group col-md-4 ">
                      <label class="col-sm-12 pl-0 pr-0 ">Image</label>
                      <div class="col-sm-12 pl-0 pr-0">
